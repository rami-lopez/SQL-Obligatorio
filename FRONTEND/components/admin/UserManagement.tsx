...
export const UserManagement: React.FC<UserManagementProps> = ({
  ...
  type SanctionPayload =
    | { fechaInicio?: string; fechaFin?: string; motivo?: string }
    | undefined;
      ...
      try {
        if (!isSanctioned) {
          ...
          await createSanction({
            idParticipante: toSanction.idParticipante,
            fechaInicio: fInicio,
            ...
            {users
              ...
              .map((user) => (
                ...
                >
                  ...
                  <td
                    className={`px-6 py-4 ${
                      currentUser?.idParticipante == user.idParticipante
                        ? "font-bold"
                        : ""
                    }`}
                  >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      {currentUser?.idParticipante !== user.idParticipante && (
                        <button
                          onClick={() => handleDelete(user.idParticipante)}
                      ...
                      {currentUser?.idParticipante === user.idParticipante ? null : activeSanctionsId.includes(user.idParticipante) ? (
                        <button
                          onClick={() => handleSanction(user, true)}
                          className="text-blue-600 hover:underline font-medium"
                        >
                          Habilitar
                        </button>
                        ...
                        <button
                          onClick={() => handleSanction(user, false)}
                          className="text-red-600 hover:underline font-medium"
                        >
                          Sancionar
                        </button>
